...
base_model = models.mobilenet_v3_large(weights=models.MobileNet_V3_Large_Weights.IMAGENET1K_V2)
if not TRAINABLE:
...
base_model.classifier[3] = nn.Linear(base_model.classifier[0].out_features, 1)
